...
function feast(beast, dish) {
    /*iterate over each string.  if first letter beast[0] === dish[0] && beast.length - 1
    and also must match the last letter
    return true */
...
/*
solution works but too slow with nested for loops.

this one is faster with .startsWith() and .endsWith() methods 
as well as:
